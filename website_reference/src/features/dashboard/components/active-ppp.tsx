        ...
        <TableBody>
          {sortedSessions.map((session, index) => (
            <TableRow key={index} className="group border-muted/30 hover:bg-muted/10 transition-colors">
              ...
              <TableCell className="py-3">
                 <a 
                   href={`http://${session.address}`}
                   target="_blank"
                   rel="noopener noreferrer"
                   className="text-[11px] font-mono font-bold bg-primary/10 px-1.5 py-0.5 rounded text-primary hover:bg-primary/20 hover:underline transition-colors cursor-pointer inline-flex items-center"
                 >
