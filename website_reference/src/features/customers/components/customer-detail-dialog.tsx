                    ...
                    <div className="space-y-3 p-3 bg-muted/30 rounded-lg border border-border/50">
                        ...
                        <div className="flex justify-between items-center text-xs">
                            ...
                            {customer['remote-address'] ? (
                                <a 
                                  href={`http://${customer['remote-address']}`}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="font-mono text-primary hover:underline hover:text-primary/80 inline-block px-1.5 py-0.5 rounded bg-primary/10 transition-colors"
                                >
                                  <PrivacyText>{customer['remote-address']}</PrivacyText>
                                </a>
                            ) : (
