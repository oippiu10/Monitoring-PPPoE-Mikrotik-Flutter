...
const NAV_ITEMS = [
  { label: 'Overview Infrastruktur', url: '/odp/capacity' },
  { label: 'Daftar ODP', url: '/odp' },
  { label: 'Daftar ODC', url: '/odp/odc' },
  { label: 'Warna Kabel', url: '/odp/cable-colors' },
  { label: 'Kalkulator Rasio', url: '/odp/ratio-calculator' },
]
