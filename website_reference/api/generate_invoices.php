...
try {
    ...
    log_admin_activity($conn, 'generate_invoices', "Menerbitkan tagihan periode {$month}/{$year} untuk router {$router_id}. Total: {$inserted} tagihan baru.", (int)($_SESSION['admin_id'] ?? 0));
