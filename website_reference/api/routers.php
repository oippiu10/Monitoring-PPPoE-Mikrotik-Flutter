    ...
    switch ($method) {
        ...
        case 'POST':
            ...
            if ($dupRow) {
                ...
                log_admin_activity($conn, 'router_update', "Update router {$name} ({$host})", (int)($_SESSION['admin_id'] ?? 0));
            ...
            log_admin_activity($conn, 'router_create', "Tambah router {$name} ({$host})", (int)($_SESSION['admin_id'] ?? 0));
        ...
        case 'DELETE':
            ...
            log_admin_activity($conn, 'router_delete', "Hapus router ID {$id}", (int)($_SESSION['admin_id'] ?? 0));
        ...
        case 'PATCH':
            ...
            log_admin_activity($conn, 'router_activate', "Set router ID {$id} sebagai router aktif", (int)($_SESSION['admin_id'] ?? 0));
