...
switch ($action) {
    case 'yearly':
        ...
        for ($m = 1; $m <= 12; $m++) {
            ...
            $sqlPay = "SELECT SUM(CASE WHEN method != 'titipan' THEN amount ELSE 0 END) as revenue, 
                              COUNT(DISTINCT CASE WHEN method != 'titipan' THEN user_id ELSE NULL END) as paid_count 
                       FROM payments 
