...
if (($handle = fopen($filename, "r")) !== FALSE) {
    ...
    session_start();
    log_admin_activity($conn, 'customer_import', "Import CSV pelanggan selesai. Ditambahkan: {$insertCount}, Diperbarui: {$updateCount}, Gagal: {$errorCount}.", (int)($_SESSION['admin_id'] ?? 0));
